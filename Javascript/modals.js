            ...
            <div class="grid-container">
              ...
              <div class="grid-item">
                ...
                <div class="modal-btn-container">
                  <button class="modal-btn">See live <img height="20px" class="pl-left" src="images/live.png" alt="live"></button>
                  <button class="modal-btn">See source <img height="20px" class="pl-left" src="images/source.png" alt="source"></button>
                </div>
              </div>
            </div>
          </div>
